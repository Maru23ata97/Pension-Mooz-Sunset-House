...
const Slider = () => (
  ...
  >
    ...
    <SwiperSlide>
      ...
      <div className="text fs-5" data-swiper-parallax="-100">
      <div>
        <p>Autrefois, Temaiatea et son épouse demeuraient à Tupuai-Manu qui s’appelle désormais Maiao. La femme tomba enceinte et accoucha d’un œuf. L’époux prit l’œuf et le porta dans une petite grotte du rivage nommée Vaionini où il le déposa.
        Une nuit, la femme eut une vision dans son sommeil. Elle vit qu’elle avait mis au monde un garçon tout jaune. Elle se réveilla et raconta ce songe à son époux. Quand vint le jour, l’homme partit observer l’œuf qu’il avait laissé dans la grotte. Les lieux atteints, il constata que l’œuf avait éclos : c’était un bébé lézard. Temaiatea donna à ce lézard le nom de Moo-rea*.</p>

        <p>Lui et sa femme nourrirent Moo-rea dans cette petite grotte jusqu’à ce qu’il soit grand. Il devint un lézard énorme. C’est pourquoi la femme prit peur et qu’elle dit à son époux : « Il nous faut abandonner Moo-rea , sinon, bientôt, il nous mangera. »Le mari n’accepta pas, disant : « C’est tout de même notre fils aîné ! » Mais comme le femme insistait, l’homme construisit une pirogue pour eux deux, ils montèrent à bord de cette pirogue, ramèrent en direction du levant jusqu’à Tahiti.</p>
        
         <p>Quant à Moo-rea, il ne cessait de se morfondre en pensant à ses parents qui l’avaient nourri. Et comme cela faisait longtemps que les Temaiatea ne lui avaient pas apporté à manger, il sut qu’on l’avait abandonné . Il se jeta à la mer et nagea vers le levant. Lorsque Moo-rea eut perdu la terre de vue, il affronta le courant Teara-Veri*, puis en sortit. Ce courant n’est pas hérissé de vaguelettes mais sa course est comme celle du scolopendre.</p>
         
         <p>Moo-rea fit face à un second courant que l’on appelle Tefara* car c’est un courant « épineux » comme le pandanus. Moo-rea se dégagea de ce courant mais il était épuisé. Il affronta un troisième courant nommé Tepua* car c’est un courant puissant : l’écume de la mer est comme de la mousse de savon. C’est dans ce courant que Moo-rea trouva la mort. Son corps dériva et s’échoua à Aimeho. Aimeho est l’ancien nom de l’île de Moorea. Au petit matin, deux hommes partirent à la pêche. Lorsqu’ils parvinrent au rivage, ils virent cette énorme chose gisant sur le sable, ils coururent avertir les gens en criant : « Un lézard jaune ! Un lézard jaune ! » Depuis ce jour on nomme Aimeho, Moo-rea c’est à dire Moorea.</p>
        </div>
      </div>
      <a className="btn btn-outline-success text-info fw-bold" href="#">
        Réserver Maintenant
      </a>
    </SwiperSlide>
  </Swiper>
